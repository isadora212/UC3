...
var Aluno = /** @class */ (function () {
    ...
    Aluno.prototype.calcularNotas = function () {
        ...
        return " A m\u00E9dia das notas de ".concat(this.nome, " \u00E9: ").concat(media);
    };
    Aluno.prototype.obterDetalhes = function () {
        console.log(" O aluno ".concat(this.nome, " ficou com ").concat(this.notas));
    };
    return Aluno;
}());
